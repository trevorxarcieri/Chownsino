...
/* ************************************************************************** */
    ...
    //The following configurations setup 
    //the SYSCLK frequency to 80 MHz and a PBCLK frequency to 40 MHz
    // DEVCFG2
    ...
    #pragma config JTAGEN = OFF              // Turn off JTAG Enable (JTAG Port Not Enabled)
